...
const features = [
    {
        ...
        description:
            'Access to verified and experienced healthcare professionals across multiple specializations.',
        color: 'text-blue-500',
    ...
    },
    {
        ...
        description:
            'Pay consultation fees securely through Stripe payment gateway.',
    ...
    },
    {
        ...
        description:
            'Read patient reviews and rate your doctors after visits.',
    ...
    },
    {
        ...
        description:
            'Check doctor availability and book slots that work for you.',
        color: 'text-pink-500',
    ...
    },
    {
        ...
        title: 'Data Privacy',
        description:
            'Your medical records are encrypted and protected at all times.',
        color: 'text-cyan-500',
        ...
        >
            ...
            "
                    ...
                    <p className="max-w-2xl mx-auto mt-6 text-lg text-default-500 leading-relaxed">
                        Experience modern healthcare with seamless appointments,
                        secure payments, trusted doctors, and complete privacy.
                    </p>
                </motion.div>
