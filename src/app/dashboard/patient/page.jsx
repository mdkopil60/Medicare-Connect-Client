...
const PatientDashboardHomepage = () => {
    ...
    if (isSessionPending || isDataLoading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[50vh] gap-3">
                ...
                <p className="text-default-500 text-sm font-medium animate-pulse">
                    Loading dashboard...
                </p>
            </div>
        );
    ...
    const stats = [
        ...
        },
        {
            ...
            route: "/dashboard/patient/payment-history"
        },
    ];
                        ...
                        >
                            <div className="flex flex-row items-center gap-4 p-5 w-full">
                                ...
                                <div className="flex flex-col items-start text-left min-w-0 flex-1">
                                    <p className="text-xs font-semibold text-default-400 uppercase tracking-wider truncate w-full">
                                        {stat.title}
                                    </p>
                            ...
                            return (
                                <Card key={doctorId} shadow="sm" className="border border-divider w-full">
                                    <div className="p-5 flex items-center gap-4 w-full">
                                        <Avatar
                                            src={doc.image || `https://ui-avatars.com/api/?name=${encodeURIComponent(doc.name || 'D')}&background=6366f1&color=fff`}
                                            name={doc.name}
